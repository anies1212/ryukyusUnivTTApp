//
//  OtherDaysTasksTableViewController.swift
//  SILSTimeTable
//
...
class OtherDaysTasksTableViewController:UITableViewController, ToDoTableViewCellDelegate, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate{
...
//        }
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let imageview = UIImageView(image: UIImage(named: "peopleBackground.jpg"))
        ...
        let label = UILabel(frame: CGRect(x: 20, y: 15, width: imageview.frame.size.width-10, height: 100))
...
"""
    ...
    func loadList() {
        ...
        query?.whereKey("deadlineDateString", greaterThan: selectedDateString)
...
// MARK: - FloatyDelegate
extension OtherDaysTasksTableViewController: FloatyDelegate {
