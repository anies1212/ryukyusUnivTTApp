...
class TodayAssignmentsTableViewController: UITableViewController, ToDoTableViewCellDelegate, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate{
...
//        }
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let imageview = UIImageView(image: UIImage(named: "headerBackground.jpg"))
        ...
        if let user = NCMBUser.current(){
            label.text = """
\(selectedDateString!)
\(user.object(forKey: "userName") as! String)さんのタスク
"""
        } else {
            print("error")
        }
...
// MARK: - FloatyDelegate
extension TodayAssignmentsTableViewController: FloatyDelegate {
