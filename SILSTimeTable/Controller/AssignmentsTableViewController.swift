...
class AssignmentsTableViewController: UITableViewController, ToDoTableViewCellDelegate, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate{
...
//        cell.contentView.layer.cornerRadius = 8
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let imageview = UIImageView(image: UIImage(named: "onlineBackground"))
...
"""
    ...
    func loadList() {
        ...
        query?.order(byAscending: "deadlineDateString")
...
// MARK: - FloatyDelegate
extension AssignmentsTableViewController: FloatyDelegate {
